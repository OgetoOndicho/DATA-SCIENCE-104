# **PROJECT TITLE: STUDENT ACADEMIC PERFORMANCE CLASSIFICATION USING DECISION TREES**
...
- Develop a Decision Tree classification model to predict students' final academic performance as either Excellent, Average, or Poor. The project utilizes academic, demographic and behavioral features to properly classify the data.
-  The goal is to identify the key factors influencing performance and provide insights that can support timely educational interventions.
...
## **Tools Used**
- Kaggle: For dataset outsourcing and downloading.
- Jupyter Notebooks: For Data Analysis and Classification Model Building.
